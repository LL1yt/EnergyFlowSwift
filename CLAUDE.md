...
- проект такой большой, что отдельные тесты не отражают всей картины. теперь пока что принимаем непростое волевое решение тестировать все через test_forward_simple_v2.py
