...
- не используем смыйлы из-за ошибки декодирования ""Python\Python311\Lib\encodings\cp1252.py", line 19, in encode return codecs.charmap_encode(input,self.errors,encoding_table)[0]"
