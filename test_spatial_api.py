...
# Попробуем вызвать find_neighbors
try:
    coords = [0, 0, 0]  # угол куба
    neighbors = lattice.spatial_optimizer.find_neighbors(coords, 1.5)
    print(f"\n✅ find_neighbors работает! Найдено {len(neighbors)} соседей для {coords}")
except Exception as e:
    print(f"\n❌ Ошибка find_neighbors: {e}")
