...
class ParallelSpatialProcessor:
    """
    ⚠️ DEPRECATED: Параллельная обработка пространственных операций
    ============================================================

    🚨 УСТАРЕЛ: Используйте GPUSpatialProcessor для лучшей производительности!

    Координирует chunking, memory management и parallel processing
    для оптимальной производительности на больших решетках.

    ЗАМЕНЕН НА: new_rebuild.core.lattice.spatial_optimization.gpu_spatial_processor.GPUSpatialProcessor
    ПРИЧИНА: GPU acceleration, async processing, better memory management
