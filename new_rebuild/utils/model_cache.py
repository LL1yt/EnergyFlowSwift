...
class ModelCacheManager:
    ...
    def is_model_cached(self, model_name: str) -> bool:
        ...
        if model_name.startswith('distilbert'):
            required_files.extend(['tokenizer.json', 'pytorch_model.bin'])
    ...
    def get_model_path(self, model_name: str) -> Optional[str]:
        """
        Получение пути к модели (локального или оригинального)
...
def get_model_cache_manager(config: Optional[SimpleProjectConfig] = None) -> ModelCacheManager:
